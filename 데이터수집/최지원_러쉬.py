...
driver.get('https://www.glowpick.com/brand/ranking?id=52')
...
df.to_csv("러쉬피부타입수정.csv")

df2= pd.read_csv("/Users/yujinkim/Desktop/DScover/thebodyshop(1).csv")

df2.tail()

idx_num = df2[df['제품']=="블랙 머스크 후레그런스 미스트"].index
