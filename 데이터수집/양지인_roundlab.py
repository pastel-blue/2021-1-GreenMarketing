...
driver.get('https://www.glowpick.com/brand/ranking?id=6094&level&category_id&is_all=true')
...
for i in range(0,100):
    ...
    #제품 리스트 추출 
    roundlab_All = driver.find_elements_by_css_selector("div > div > div.product-item__info__details.details > div.details__labels > p.details__labels__name") 
    
    model = roundlab_All[i].text
    print(i,"번째 제품: ", model)
    
    #제품 페이지 들어가기
    roundlab_All[i].click()
    time.sleep(2)
